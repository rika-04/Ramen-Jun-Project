  ...
  Ramen: {
    "Miso Ramen": {
      ...
      items: [
        ...
        { name: "Spicy Miso Ramen", desc: "Spicy miso broth, ground pork, bean sprouts.", price: "18,00", allergens: [3,4,6], img:"/images/ramen/Ramen_SpMiso.jpg" },
        ...
        { name: "Miso Cheese Ramen", desc: "", price: "20,30", allergens: [4,6], img:"/images/ramen/Ramen_MisoCheese.jpg" },
        ...
        { name: "Miso Deluxe Ramen", desc: "", price: "20,60", img: "/images/ramen/Ramen_MisoDeluxeRamen.jpg" , allergens: [4,6]},
    ...
    "Shio Ramen": {
      ...
      "Special Miso Ramen": {
        items:[
        { name: "Karaage Miso Ramen", desc: "", price: "20,80", img:"/images/ramen/Ramen_KaraageMiso.jpg" },
        ...
        { name: "Yasai Miso Ramen", desc: "", price: "19,60", img: "/images/ramen/Ramen_YasaiMisoRamen.jpg" },
        ...
        { name: "Seafood Miso Ramen", desc: "", price: "21,00" , img:"/images/ramen/Ramen_SeafoodMiso.jpg"},
    ...
    "Veggie Ramen": {
      items:[
      { name: "Veggie Miso Ramen", desc: "", price: "17,50", img:"/images/ramen/Ramen_VeggieMisoNoSp.jpg" },
      { name: "Spicy Veggie Miso Ramen", desc: "Vegetarische Brühe mit Misopaste, Weizennudeln, Frühlingszwiebeln, Tomaten, Paprika, Zwiebeln, Champignons, Kartoffeln, Auberginen, Zucchini, Bratpaprika, Sesam und Tofu", price: "19,50", img:"/images/ramen/Ramen_VeggieMiso.jpg" },
      { name: "Veggie White Ramen", desc: "", price: "18,00" },
      { name: "Spicy Veggie White Ramen", desc: "Vegetarische Brühe mit Misopaste, Weizennudeln, Sojamilch, Lauch, gerösteten Knoblauch, gerösteter Tomate, Kikurage Pilzen, Avocado und Sojaschnitzel (enthält Spuren von Ingewer, Pilzen und Chili)", price: "19,50", allergens: [3], img: "/images/ramen/Ramen_VeggieWhiteRamen.jpg" },
      ]
     },
    },
    ...
    "Vorspeisen":{
      items:[
        ...
        "Salate":{
          ...
          { name: "Gurken & Sesam", desc: "Eingelegte Gurken in Scheiben mit Sesamöl-Dressing", price: "5,20", img:"/images/sides/Side_Gurken&Sesam.png" },
        ],
        },
        "Donburi (Reisschüsseln)":{items:[
          { name: "Negi Chashu Don (klein)", desc: "Chashu Schweinefleischscheiben, Frühlingszwiebeln, Sesamkörner und Sesamöl serviert mit Reis", price: "5,80",img:"/images/sides/Don_NegiChashu.jpg" },
          { name: "Chicken Nanban Don (klein)", desc: "Saftiges Hühnerschenkelfleisch in einer würzigen Marinade knusprig frittiert mit hausgemachter süß-sauer Soße und Tartar Soße (aus gekochtem Ei) serviert mit Reis", price: "7,20", img:"/images/sides/Don_ChickenNanban.jpg" },
        ],
    },
  },
    Deserts: {
